...
8. Scroll down to the section **`Complexity Score`** and expand the list of issues. 
    ...
    *In this example, there is 7 issues of which 4 have an automated fix, indicated by an icon as shown below:*
...
9. Click on **View migration plan** on the top right to view the Download migration plan.

10. Click on **Download plan** to download the **Migration Plan** generated by AMA.
...
- **Apply automated fixes with IBM Bob** — You used IBM Bob's Java Modernization workflow to apply OpenRewrite recipes, automatically resolving known migration issues such as WebSphere Servlet API and runtime API incompatibilities.
